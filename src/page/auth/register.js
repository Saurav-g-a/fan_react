            ...
            <div className='grid lg:grid-cols-12 md:grid-cols-6 sm:grid-cols-6 s:grid-cols-6 gap-4'>
                <div className='lg:col-span-5 md:col-span-6 sm:col-span-6 s:col-span-6 p-10'>
                    ...
                    <div className='mt-12 lg:px-12 md:px-3 sm:px-3 s:px-3 '>
                        <button className='bg-[#FF007A] w-full rounded-xl mb-3 text-white p-4 text-2xl font-Zuume'>Register as creator</button>
                        ...
                        <button className='bg-[#FF007A] w-full rounded-xl mb-3 text-white p-4 text-2xl font-Zuume'>Register in as fan</button>
                    </div>
                    <p className='font-Zuume text-lg text-white text-center'>already have an account? <a href="/login" className='font-bold text-white'> login </a></p>
                </div>
