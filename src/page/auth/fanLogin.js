            ...
            <div className='grid lg:grid-cols-12 md:grid-cols-6 sm:grid-cols-6 s:grid-cols-6 gap-4'>
                <div className='lg:col-span-5 md:col-span-6 sm:col-span-6 s:col-span-6 p-10 overflow-y-auto max-h-screen'>
                    ...
                    <div className='mt-12 lg:px-12 md:px-3 sm:px-3 s:px-3'>
                        <p className='font-Zuume text-[60px] font-bold leading-[45px] text-white'>fan <br />
                            SIGN UP</p>
                        <div className='my-5'>
                        ...
                        <button className='bg-[#FF007A] w-full rounded-xl mb-3 text-white p-4 text-2xl font-Zuume'>Sign in</button>

                        <p className='font-Zuume text-lg text-white text-center'>already have an account? <span className='font-bold text-white'> sign up </span></p>
                    </div>
                </div>
